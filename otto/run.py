...
def main():
    ...
    logloss = metrics.make_scorer(score_func=logloss_mc, greater_is_better=False
                                     , needs_proba=True)
    result = cross_validation.cross_val_score(clf, train, labels, cv=3, scoring=logloss)
    print "Scores: ", result
